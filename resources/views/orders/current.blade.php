...
<div class="content-middle">
  ...
  <div class="content-head__title-wrap">
    <div class="content-head__title-wrap__title bcg-title">{{ __('Мои заказы') }}</div>
  </div>
  <div class="content-head__search-block">
    ...
    <div class="cart-product-list">
      @forelse ($goods as $good)
        <div class="cart-product-list__item">
          <div class="cart-product__item__product-photo">
            <img src="/img/cover/game-{{ $good->getImageId() }}.jpg" class="cart-product__item__product-photo__image">
          </div>
      ...
      <div class="cart-product-list__result-item">
        ...
        <div class="cart-product-list__result-item__value">{{ $totalSumOrders }} рублей</div>
      </div>
    </div>
